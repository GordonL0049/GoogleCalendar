...
@DesignerComponent(
        version = 1,
        description = "A non-visible extension that allows you to manage your Google Calendars in App Inventor.<br><br>Made by Gordon Lu (AICODE).",
        category = ComponentCategory.EXTENSION,
        nonVisible = true,
        iconName = "https://docs.google.com/drawings/d/e/2PACX-1vRJrasx7ovwOOugAq1KD0ENtaiZSjJ1795zgQuUTFJRrwfzM1EOe-o51eEQxPhM3leERnW7DOEx2BzR/pub?w=16&h=16")
